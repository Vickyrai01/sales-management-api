...
public class BranchController {
    ...
    @Operation(
            ...
            description = "Retrieves a list of all branches. Requires ADMIN or STOCK_MANAGER role."
    )
    ...
    @Operation(
            ...
            description = "Retrieves a specific branch by its ID. Requires ADMIN or STOCK_MANAGER role."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Creates a new branch. Requires ADMIN role."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Updates an existing branch. Requires ADMIN role."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Deletes a branch by ID. Requires ADMIN role."
    )
    @ApiResponses(value = {
